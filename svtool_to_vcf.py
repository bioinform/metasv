...
if __name__ == "__main__":
  parser = argparse.ArgumentParser("Convert SV tool output file to VCF", formatter_class = argparse.ArgumentDefaultsHelpFormatter)
  ...
  parser.add_argument("--tool", help = "Tool name", required = False, default = "BreakDancer", choices = ["BreakDancer", "CNVnator", "Pindel"])
